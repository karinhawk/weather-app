            ...
            <div className="modal__floater">
                <div className="modal__content">
                    ...
                    <div className="modal__options">
                        <h1 className="modal__options__heading">OPTIONS</h1>
                        <div className="modal__options__questions">
                        <h2 className="modal__options__prompt">Choose Celsius or Fahrenheit</h2>
